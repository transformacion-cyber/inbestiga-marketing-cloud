/* INBESTIGA Marketing Cloud v17.12.13.4 · SAKURA permanent presence + top navigation access */
(() => {
  "use strict";
  if (window.INBESTIGA_SAKURA_LOADER?.version === "v17.12.13.4") return;
  const VERSION = "v17.12.13.4";
  const MODULE = "sakura-presence-loader-v17-12-13-4";
  ...
  async function loadWorkspace() {
    ...
    loading = new Promise((resolve, reject) => {
      if (!document.querySelector('link[data-sakura-native-css]')) {
        ...
        link.rel = "stylesheet";
        link.href = "assets/css/sakura-apple-workspace-v17-12-13-4.css";
        link.dataset.sakuraNativeCss = "1";
        document.head.appendChild(link);
      }
      const script = document.createElement("script");
      script.src = "assets/js/sakura-apple-workspace-v17-12-13-4.js";
      script.async = true;
  ...
  function registerBuild() {
    ...
    window.INBESTIGA_BUILD = {
      ...build,
      version: VERSION,
      name: "SAKURA RELIABLE ACTIONS & APPLE WORKSPACE",
