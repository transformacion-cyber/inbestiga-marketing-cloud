/* INBESTIGA Marketing Cloud v17.16.3 · SOLICITUDES 360 · AUDIO RECOVERY & COMPLETE TASK HANDOFF */
(()=>{
  "use strict";
  const VERSION="v17.16.3",NAME="SOLICITUDES 360 · AUDIO RECOVERY & COMPLETE TASK HANDOFF",MODULE="release-marker-v17-16-3";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"requests360-audio-task-handoff",polling:false,realtimeChannels:1,mutationObservers:0,backendChanges:false})}catch{}
})();
