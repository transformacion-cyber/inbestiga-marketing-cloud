/* INBESTIGA Marketing Cloud v17.16.2 · SOLICITUDES 360 · CUSTOM AREA & REALTIME REQUEST NOTIFICATIONS */
(()=>{
  "use strict";
  const VERSION="v17.16.2",NAME="SOLICITUDES 360 · CUSTOM AREA & REALTIME REQUEST NOTIFICATIONS",MODULE="release-marker-v17-16-2";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"requests360-custom-area-realtime-notifications",polling:false,realtimeChannels:1,mutationObservers:0,backendChanges:false})}catch{}
})();
