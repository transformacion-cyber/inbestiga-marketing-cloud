/* INBESTIGA Marketing Cloud v17.15.13 · SAKURA AUTHENTICATED ORB MOUNT & PWA ACTIVATION HOTFIX */
(()=>{
  "use strict";
  const VERSION="v17.15.13",NAME="SAKURA AUTHENTICATED ORB MOUNT & PWA ACTIVATION HOTFIX",MODULE="release-marker-v17-15-13";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"authenticated-orb-pwa-activation",polling:false,realtimeChannels:0,mutationObservers:0,backendChanges:false})}catch{}
})();
