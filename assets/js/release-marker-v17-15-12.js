/* INBESTIGA Marketing Cloud v17.15.12 · SAKURA POST-LOGIN AMBIENT ORB VISIBILITY HOTFIX */
(()=>{
  "use strict";
  const VERSION="v17.15.12",NAME="SAKURA POST-LOGIN AMBIENT ORB VISIBILITY HOTFIX",MODULE="release-marker-v17-15-12";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"post-login-orb-visibility-hotfix",polling:false,realtimeChannels:0,mutationObservers:0,backendChanges:false})}catch{}
})();
