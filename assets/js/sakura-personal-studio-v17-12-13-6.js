...
(() => {
  ...
  function normalize(raw){
    ...
    ["panelColor1","panelColor2","panelColor3","frameColor","headerColor1","headerColor2","headerText","headerMuted","text","muted","accent","accent2","userBubble","userText","assistantBubble","assistantText","inputBg","inputText","buttonBg","buttonText","orbPrimary","orbSecondary","orbTertiary","orbGlow","messageAccent","teamIncoming","teamOutgoing","teamText"].forEach(k=>s[k]=hex(s[k],DEFAULTS[k]||"#ffffff"));
  ...
  async function handleClick(event){
    ...
    if(target.dataset.skstudioTheme){draft=normalize({...draft,...THEMES[target.dataset.skstudioTheme],theme:target.dataset.skstudioTheme});refreshPreview();return true}
