/* ===== RUNTIME-AWARE AUDIT HEALTH INTEGRATION · v17.12.13.5 ===== */
(function () {
  "use strict";

  if (window.INBESTIGA_AUDIT_HEALTH) return;

  const VERSION = window.INBESTIGA_PUBLIC_RUNTIME_CONFIG?.version || document.documentElement.dataset.inbestigaBuild || "v17.12.13.5";
