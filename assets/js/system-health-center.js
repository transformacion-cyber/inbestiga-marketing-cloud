  ...
  async function pwaHealth() {
    ...
    try {
      ...
      try {
        ...
        cacheName = names.find((name) => name.includes("inbestiga-v17-12-9")) || names.find((name) => name.includes("inbestiga")) || "";
      } catch { /* CacheStorage puede estar restringido */ }
      const expectedCache = cacheName.includes("inbestiga-v17-12-9");
