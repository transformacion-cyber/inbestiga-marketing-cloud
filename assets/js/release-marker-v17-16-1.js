/* INBESTIGA Marketing Cloud v17.16.1 · SOLICITUDES 360 · APPLE LIQUID GLASS PORTAL UX HOTFIX */
(()=>{
  "use strict";
  const VERSION="v17.16.1",NAME="SOLICITUDES 360 · APPLE LIQUID GLASS PORTAL UX HOTFIX",MODULE="release-marker-v17-16-1";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"solicitudes360-apple-liquid-glass-hotfix",polling:false,realtimeChannels:1,mutationObservers:0,backendChanges:false})}catch{}
})();
