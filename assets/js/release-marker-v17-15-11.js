/* INBESTIGA Marketing Cloud v17.15.11 · SAKURA AMBIENT PRESENCE, AFFECTIVE INTELLIGENCE & TASK DEEP LINKS */
(()=>{
  "use strict";
  const VERSION="v17.15.11",NAME="SAKURA AMBIENT PRESENCE, AFFECTIVE INTELLIGENCE & TASK DEEP LINKS",MODULE="release-marker-v17-15-11";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"ambient-affective-task-deep-links",polling:false,realtimeChannels:0,mutationObservers:0,backendChanges:false})}catch{}
})();
