/* INBESTIGA Marketing Cloud v17.16.6 · SAKURA MESSAGING · WHATSAPP-STYLE PRODUCTIVE CHAT V1 */
(()=>{
  "use strict";
  const VERSION="v17.16.6",NAME="SAKURA MESSAGING · WHATSAPP-STYLE PRODUCTIVE CHAT V1",MODULE="release-marker-v17-16-6";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"sakura-whatsapp-style-messaging-v1",polling:false,realtimeChannels:0,mutationObservers:0,backendChanges:false})}catch{}
})();
