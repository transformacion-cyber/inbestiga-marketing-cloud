/* INBESTIGA Marketing Cloud v17.16.5 · CREATIVE ARENA · APPLE STUDIO & MAGIC THEME COLLECTION */
(()=>{
  "use strict";
  const VERSION="v17.16.5",NAME="CREATIVE ARENA · APPLE STUDIO & MAGIC THEME COLLECTION",MODULE="release-marker-v17-16-5";
  ...
  try{window.INBESTIGA_QUALITY_CORE?.register?.(MODULE,{version:VERSION,mode:"creative-arena-visual-themes",polling:false,realtimeChannels:0,mutationObservers:0,backendChanges:false})}catch{}
})();
