/* INBESTIGA Marketing Cloud v17.14.1 · SAKURA Button Text Contrast & Studio Color Sync permanent presence */
(() => {
  "use strict";
  if (window.INBESTIGA_SAKURA_LOADER?.version === "v17.14.1") return;
  const VERSION = "v17.14.1";
  const MODULE = "sakura-presence-loader-v17-14-1";
  ...
  async function loadWorkspace(){
    ...
    loading=(async()=>{
      addCss("assets/css/sakura-personal-workspace-base-v17-12-13-6.css","base");addCss("assets/css/sakura-affective-task-intelligence-v17-15-11.css","affective-task-intelligence-v17-15-11");addCss("assets/css/sakura-personal-studio-v17-12-13-6.css","personal-studio");addCss("assets/css/sakura-adaptive-intelligence-v17-13-0.css","adaptive-intelligence");addCss("assets/css/sakura-live-motion-background-fusion-v17-13-2.css","live-motion-background-fusion");addCss("assets/css/sakura-academy-v17-14-0.css","academy-v17-14-0");addCss("assets/css/sakura-button-text-contrast-v17-14-1.css","button-text-contrast-v17-14-1");
      await loadScript("assets/js/sakura-personal-workspace-v17-12-13-6.js","workspace-v17-12-13-6");
      if(flags.academy!==false)await loadScript("assets/js/sakura-academy-v17-14-0.js","academy-v17-14-0");
